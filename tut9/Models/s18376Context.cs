...
{
    public partial class s18376Context : DbContext
    {
        public s18376Context()
        {
        }

        public s18376Context(DbContextOptions<s18376Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s18376;Integrated Security=True");
            }
        }
